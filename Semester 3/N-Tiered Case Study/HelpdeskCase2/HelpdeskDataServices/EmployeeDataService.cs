...
namespace HelpdeskDataServices
{
    ...
    public class EmployeeDataService : IEmployeeDataService
    {
        ...
        public List<SerializedEmployee> GetAll()
        {
            HelpDeskDBEntities dbContext = new HelpDeskDBEntities();
            List<SerializedEmployee> employees = new List<SerializedEmployee>();
            List<SerializedEmployee> busEmployees = new List<SerializedEmployee>();

            try
            {
                foreach (Employee emp in dbContext.Employees)
                {
                    SerializedEmployee empBus = new SerializedEmployee();
        ...
        public List<SerializedEmployee> GetAllTechs()
        {
            HelpDeskDBEntities dbContext = new HelpDeskDBEntities();
            List<SerializedEmployee> employees = new List<SerializedEmployee>();
            List<SerializedEmployee> busEmployees = new List<SerializedEmployee>();
