...
{
    public class ConfigBusinessUser
    {
        /// <summary>
        ...
        public static void ErrorRoutine(Exception e, string obj, string method)
        {
            ...
            {
                log.WriteEntry("Error in HelpdeskUserObjects, object=" + obj +
            ...
            {
                log.WriteEntry("Error in HelpdeskBusinessUserObjects, objects=" + obj +
        ...
        {
            EmployeeDataReference.SerializedEmployee empBus = new EmployeeDataReference.SerializedEmployee();
            empBus.DepartmentID = 0;
