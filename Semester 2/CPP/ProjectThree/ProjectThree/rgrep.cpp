...
//Line 52: sortVectorSize function - overloaded sort function that sorts a vector of vectors
//Line 62: grep function - searches files for search term and produces a vector to populate an outer vector
//         that will output search term lines, also returns an int value to be used in the scan functions
//Line 143: quietScan function - scans directories but doesn't pass in a container vector for verbose output
//Line 221: scan function - produces verbose output and sorts results with sortVector function
//Line 286: defaultRecursiveScan - recurses, doesn't sort, verbose
//Line 367: nonRecursiveScan - non-recursive, sorts Vector, verbose
//Line 440: defaultNonRecursiveScan - non-recursive, doesn't sort
//Line 507: main - associates switches with booleans and produces if statements for all combinations of switches
